...
This function is controlled by header arguments.
  :create t     - Creates a new customer-managed policy.
  :delete t     - Deletes an inline or customer-managed policy.
  :detach t     - Detaches a managed policy from the role.
  <no action>  - Creates/updates an inline policy or updates any other policy type."
